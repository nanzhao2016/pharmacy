...
def writeResult(model):
	...
	os.path.join('data/table_sante/', 'qda_summary_allergy2.txt')
	file = open ('data/table_sante/qda_summary_allergy2.txt', 'a')
	file.write('Summary: \n')
	file.write('-'*50)
	file.write('\n')
	...
	os.path.join('data/table_sante/', 'qda_best_pred_allergy2.txt')
	np.savetxt('data/table_sante/qda_best_pred_allergy2.txt', pred)
	file.write(str(pred))
	file.write('\n')
	file.write('\n')
	file.write('-'*50)
	...
	os.path.join('data/table_sante/', 'qda_best_proba_allergy2.txt')
	np.savetxt('data/table_sante/qda_best_proba_allergy2.txt', proba)
...
if __name__ == '__main__':	
	...
	params = {'priors':[None], 'reg_param ':[0.0], 'store_covariances': [True]}
